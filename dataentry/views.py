...
def import_data(request):
    if request.method == "POST":
        ...
        messages.success(request, "Your data is being imported. You will be notified once it is complete.")
        return redirect("import_data")
...
def export_data(request):
    if request.method == "POST":
        ...
        # how the message to the user
        messages.success(request, "Your data has been exported. You will be notified once it is complete.")
