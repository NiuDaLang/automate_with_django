...
def send_email(request):
    if request.method == "POST":
        ...
        if email_form.is_valid():
            ...
            send_email_task.delay(mail_subject, text, to_email, email_id, attachment, body)
...
def track_open(request, unique_id):
    ...
    try:
        ...
        if not email_tracking.opened_at:
            ...
            print("Email has already been opened!")
            return HttpResponse("Email has already been opened!")
    except:
        return HttpResponse("Email tracking record not found!")
